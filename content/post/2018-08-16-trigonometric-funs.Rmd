...
En mis épocas más humanísticas adquirí cierta admiración por los antiguos griegos y siempre me dió intriga la trigonometría. En este post armo un gráfico de las dos funciones trigonométricas más famosas. La complicación más grande fue especificar la leyenda de las dos curvas y los caracteres griegos en los ejes.

Para dibujar las funciones, uso `stat_function`, `geom_segment` para los ejes y `scale_x_continuous` para especificar la posición y etiqueta de las guías.
