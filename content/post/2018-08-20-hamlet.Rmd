...
In this post I go over the text of Hamlet, Prince of Denmark, by William Shakespeare using quantity of lines spoken by character to visualize the dynamic of the play.We'll get the chance to use `dplyr` and some `regular expressions`.
