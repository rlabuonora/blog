...
The text of Shakespeare's plays is available from the `gutenberg` package. I downloaded the text and made it available as a data frame [here](/post/data/shakespeare_plays.rds)
