...
El mapa publicado por el INE se carga como un objecto `SpatialPolygonsDataFrame`. Para saber más sobre esta estructura de datos, recomiendo leer el capítulo 2 de [Geocomputation with R](https://geocompr.robinlovelace.net/).
...
Una vez calculada esta estimación, elijo una localidad para subsetear el mapa, y linkeo el mapa con las medianas por sección
