---
title: "Cirlces & Parabolas with ggplot"
author: "rafa"
date: '2018-09-15'
slug: conic-sections
tags: []
...
p_equipoints <- p_annotated + geom_point(data = pt, aes(x=x, y=y)) + 
  ...
  annotate("text")
p_equipoints
# TODO: choose an x and get the point in
# the parabola and draw segments to focus and to directrix
```
