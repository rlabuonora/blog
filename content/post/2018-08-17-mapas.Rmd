...
El grupo `StreetView` permite agrupar esta capa del mapa para invocarla después (con los checkboxes).

`addLayerControl` es una capa de controles con dos checkboxes que permiten prender y apagar las dos capas del mapa (StreetView e INE).
