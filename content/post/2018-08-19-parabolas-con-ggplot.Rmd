...
## Parábola
Una parábola es un conjunto de puntos que equidista de una línea (directrix) y un foco. Estos puntos satisfacen:
...
Definiendo una función y usando `stat_fun`:

```{r}
library(latex2exp)

fun.1 <- function(x) { x^2 }
g_2 <- ggplot(data_frame(x=0), aes(x=x))
g_2 + 
...
En todos los puntos de la parábola, la distancia del punto al foco es igual que al foco.
